...
typedef GPB_ENUM(Features_Capability) {
  ...
  Features_Capability_CapabilityLisk GPB_DEPRECATED_MSG("hw.trezor.messages.management.Features.Capability_Lisk is deprecated (see messages-management.proto).") = 8,
 ...
 **/
GPB_FINAL @interface MessagesManagementRoot : GPBRootObject
@end
...
@property(nonatomic, readwrite) BOOL skipPassphrase GPB_DEPRECATED_MSG("hw.trezor.messages.management.Initialize._skip_passphrase is deprecated (see messages-management.proto).");
@property(nonatomic, readwrite) BOOL hasSkipPassphrase GPB_DEPRECATED_MSG("hw.trezor.messages.management.Initialize._skip_passphrase is deprecated (see messages-management.proto).");
...
@property(nonatomic, readwrite) BOOL passphraseCached GPB_DEPRECATED_MSG("hw.trezor.messages.management.Features._passphrase_cached is deprecated (see messages-management.proto).");
@property(nonatomic, readwrite) BOOL hasPassphraseCached GPB_DEPRECATED_MSG("hw.trezor.messages.management.Features._passphrase_cached is deprecated (see messages-management.proto).");
...
@property(nonatomic, readwrite) uint32_t passphraseSource GPB_DEPRECATED_MSG("hw.trezor.messages.management.ApplySettings._passphrase_source is deprecated (see messages-management.proto).");
@property(nonatomic, readwrite) BOOL hasPassphraseSource GPB_DEPRECATED_MSG("hw.trezor.messages.management.ApplySettings._passphrase_source is deprecated (see messages-management.proto).");
